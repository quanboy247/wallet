...
} from '@app/data/query-stacks/non-fungible-tokens/non-fungible-token-holdings.hooks';
...
import { useAllAccountsAvailableStxBalance } from '@app/data/query-stacks/balance/balance.hooks';
