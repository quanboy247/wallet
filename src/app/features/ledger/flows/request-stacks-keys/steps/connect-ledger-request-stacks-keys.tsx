...
export const ConnectLedgerRequestStacksKeys = () => {
  const {
  ...
  useWhenReattemptingLedgerConnection(() => pullStacksPublicKeysFromDevice());
  ...
  return (
    <ConnectLedgerLayout
      ...
      showInstructions
      onConnectLedger={pullStacksPublicKeysFromDevice}
    />
  );
};
